...
Elm.Event = Elm.Event || {};
Elm.Event.Model = Elm.Event.Model || {};
Elm.Event.Model.make = function (_elm) {
   "use strict";
   _elm.Event = _elm.Event || {};
   _elm.Event.Model = _elm.Event.Model || {};
   if (_elm.Event.Model.values) return _elm.Event.Model.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var Event = F4(function (a,b,c,d) {    return {author: a,id: b,label: c,marker: d};});
   var Author = F2(function (a,b) {    return {id: a,name: b};});
   var Marker = F2(function (a,b) {    return {lat: a,lng: b};});
   return _elm.Event.Model.values = {_op: _op,Marker: Marker,Author: Author,Event: Event};
};
Elm.EventAuthorFilter = Elm.EventAuthorFilter || {};
Elm.EventAuthorFilter.Model = Elm.EventAuthorFilter.Model || {};
Elm.EventAuthorFilter.Model.make = function (_elm) {
   "use strict";
   _elm.EventAuthorFilter = _elm.EventAuthorFilter || {};
   _elm.EventAuthorFilter.Model = _elm.EventAuthorFilter.Model || {};
   if (_elm.EventAuthorFilter.Model.values) return _elm.EventAuthorFilter.Model.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var initialModel = $Maybe.Nothing;
   return _elm.EventAuthorFilter.Model.values = {_op: _op,initialModel: initialModel};
};
Elm.EventCompanyFilter = Elm.EventCompanyFilter || {};
Elm.EventCompanyFilter.Model = Elm.EventCompanyFilter.Model || {};
Elm.EventCompanyFilter.Model.make = function (_elm) {
   "use strict";
   _elm.EventCompanyFilter = _elm.EventCompanyFilter || {};
   _elm.EventCompanyFilter.Model = _elm.EventCompanyFilter.Model || {};
   if (_elm.EventCompanyFilter.Model.values) return _elm.EventCompanyFilter.Model.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   var _op = {};
   var initialModel = $Maybe.Nothing;
   return _elm.EventCompanyFilter.Model.values = {_op: _op,initialModel: initialModel};
};
Elm.EventList = Elm.EventList || {};
Elm.EventList.Model = Elm.EventList.Model || {};
Elm.EventList.Model.make = function (_elm) {
   "use strict";
   _elm.EventList = _elm.EventList || {};
   _elm.EventList.Model = _elm.EventList.Model || {};
   if (_elm.EventList.Model.values) return _elm.EventList.Model.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var initialModel = {filterString: "",selectedEvent: $Maybe.Nothing};
   var Model = F2(function (a,b) {    return {filterString: a,selectedEvent: b};});
   return _elm.EventList.Model.values = {_op: _op,Model: Model,initialModel: initialModel};
};
...
Elm.Pages = Elm.Pages || {};
Elm.Pages.Event = Elm.Pages.Event || {};
Elm.Pages.Event.Model = Elm.Pages.Event.Model || {};
Elm.Pages.Event.Model.make = function (_elm) {
   "use strict";
   _elm.Pages = _elm.Pages || {};
   _elm.Pages.Event = _elm.Pages.Event || {};
   _elm.Pages.Event.Model = _elm.Pages.Event.Model || {};
   if (_elm.Pages.Event.Model.values) return _elm.Pages.Event.Model.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Event$Model = Elm.Event.Model.make(_elm),
   $EventAuthorFilter$Model = Elm.EventAuthorFilter.Model.make(_elm),
   $EventCompanyFilter$Model = Elm.EventCompanyFilter.Model.make(_elm),
   $EventList$Model = Elm.EventList.Model.make(_elm),
   $Http = Elm.Http.make(_elm),
   ...
   $Time = Elm.Time.make(_elm);
   var _op = {};
   var Model = F6(function (a,b,c,d,e,f) {    return {events: a,eventList: b,status: c,eventCompanyFilter: d,eventAuthorFilter: e,leaflet: f};});
   var HttpError = function (a) {    return {ctor: "HttpError",_0: a};};
   ...
   var initialModel = {events: _U.list([])
                      ,eventList: $EventList$Model.initialModel
                      ,status: Init
                      ,eventCompanyFilter: $EventCompanyFilter$Model.initialModel
                      ,eventAuthorFilter: $EventAuthorFilter$Model.initialModel
                      ,leaflet: $Leaflet$Model.initialModel};
   return _elm.Pages.Event.Model.values = {_op: _op
                                          ,Init: Init
                                          ,Fetching: Fetching
                                          ,Fetched: Fetched
                                          ,HttpError: HttpError
...
Elm.App.Model.make = function (_elm) {
   ...
   $Pages$Event$Model = Elm.Pages.Event.Model.make(_elm),
   ...
   var initialModel = {accessToken: ""
                      ...
                      ,configError: false
                      ,companies: _U.list([])
                      ,events: $Pages$Event$Model.initialModel
...
Elm.Config.make = function (_elm) {
   ...
   var prodBackend = {backendUrl: "http://live-syui.pantheonsite.io",githubClientId: "051523e381865ad2155b",name: "gh-pages",hostname: "syui.github.io"};
   ...
   var getErrorMessageFromHttpResponse = function (err) {
      ...
      {case "Timeout": return "Connection has timed out";
         case "BadResponse": var _p1 = _p0._0;
           ...
           429) ? "Too many login requests with the wrong username or password. Wait a few hours before trying again" : "Some error has occurred on the server";
         case "NetworkError": return "A network error has occurred";
         default: return A2($Basics._op["++"],"Unknown error has occurred: ",_p0._0);}
   };
...
Elm.Event = Elm.Event || {};
Elm.Event.Decoder = Elm.Event.Decoder || {};
Elm.Event.Decoder.make = function (_elm) {
   "use strict";
   _elm.Event = _elm.Event || {};
   _elm.Event.Decoder = _elm.Event.Decoder || {};
   if (_elm.Event.Decoder.values) return _elm.Event.Decoder.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Event$Model = Elm.Event.Model.make(_elm),
   ...
   var decode = function () {
      var numberFloat = $Json$Decode.oneOf(_U.list([$Json$Decode.$float,A2($Json$Decode.customDecoder,$Json$Decode.string,$String.toFloat)]));
      var marker = A3($Json$Decode.object2,$Event$Model.Marker,A2($Json$Decode._op[":="],"lat",numberFloat),A2($Json$Decode._op[":="],"lng",numberFloat));
      var number = $Json$Decode.oneOf(_U.list([$Json$Decode.$int,A2($Json$Decode.customDecoder,$Json$Decode.string,$String.toInt)]));
      var author = A3($Json$Decode.object2,$Event$Model.Author,A2($Json$Decode._op[":="],"id",number),A2($Json$Decode._op[":="],"label",$Json$Decode.string));
   ...
   return _elm.Event.Decoder.values = {_op: _op,decode: decode};
};
Elm.EventAuthorFilter = Elm.EventAuthorFilter || {};
Elm.EventAuthorFilter.Update = Elm.EventAuthorFilter.Update || {};
Elm.EventAuthorFilter.Update.make = function (_elm) {
   "use strict";
   _elm.EventAuthorFilter = _elm.EventAuthorFilter || {};
   _elm.EventAuthorFilter.Update = _elm.EventAuthorFilter.Update || {};
   if (_elm.EventAuthorFilter.Update.values) return _elm.EventAuthorFilter.Update.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $EventAuthorFilter$Model = Elm.EventAuthorFilter.Model.make(_elm),
   ...
   var init = $EventAuthorFilter$Model.initialModel;
   return _elm.EventAuthorFilter.Update.values = {_op: _op,init: init,SelectAuthor: SelectAuthor,UnSelectAuthor: UnSelectAuthor,update: update};
};
Elm.EventCompanyFilter = Elm.EventCompanyFilter || {};
Elm.EventCompanyFilter.Update = Elm.EventCompanyFilter.Update || {};
Elm.EventCompanyFilter.Update.make = function (_elm) {
   "use strict";
   _elm.EventCompanyFilter = _elm.EventCompanyFilter || {};
   _elm.EventCompanyFilter.Update = _elm.EventCompanyFilter.Update || {};
   if (_elm.EventCompanyFilter.Update.values) return _elm.EventCompanyFilter.Update.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Company$Model = Elm.Company.Model.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var update = F3(function (companies,action,model) {
      var _p0 = action;
      var isValidCompany = function (val) {    return $List.length(A2($List.filter,function (company) {    return _U.eq(company.id,val);},companies));};
      var eventCompanyFilter = function () {
         var _p1 = _p0._0;
         if (_p1.ctor === "Just") {
               var _p2 = _p1._0;
               return _U.cmp(isValidCompany(_p2),0) > 0 ? $Maybe.Just(_p2) : $Maybe.Nothing;
            } else {
               return $Maybe.Nothing;
            }
      }();
      return eventCompanyFilter;
   });
   var SelectCompany = function (a) {    return {ctor: "SelectCompany",_0: a};};
   var init = $EventCompanyFilter$Model.initialModel;
   return _elm.EventCompanyFilter.Update.values = {_op: _op,init: init,SelectCompany: SelectCompany,update: update};
};
Elm.EventList = Elm.EventList || {};
Elm.EventList.Update = Elm.EventList.Update || {};
Elm.EventList.Update.make = function (_elm) {
   "use strict";
   _elm.EventList = _elm.EventList || {};
   _elm.EventList.Update = _elm.EventList.Update || {};
   if (_elm.EventList.Update.values) return _elm.EventList.Update.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Event$Model = Elm.Event.Model.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var update = F3(function (events,action,model) {
      var _p0 = action;
      switch (_p0.ctor)
      {case "FilterEvents": return _U.update(model,{filterString: _p0._0});
         case "SelectEvent": return _U.update(model,{selectedEvent: _p0._0});
         default: return _U.update(model,{selectedEvent: $Maybe.Nothing});}
   });
   var init = $EventList$Model.initialModel;
   ...
   return _elm.EventList.Update.values = {_op: _op,FilterEvents: FilterEvents,SelectEvent: SelectEvent,UnSelectEvent: UnSelectEvent,init: init,update: update};
};
Elm.EventList = Elm.EventList || {};
Elm.EventList.Utils = Elm.EventList.Utils || {};
Elm.EventList.Utils.make = function (_elm) {
   "use strict";
   _elm.EventList = _elm.EventList || {};
   _elm.EventList.Utils = _elm.EventList.Utils || {};
   if (_elm.EventList.Utils.values) return _elm.EventList.Utils.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Event$Model = Elm.Event.Model.make(_elm),
   ...
   $String = Elm.String.make(_elm);
   var _op = {};
   var filterEventsByString = F2(function (events,filterString) {
      var filterString$ = $String.trim(filterString);
      return $String.isEmpty(filterString$) ? events : A2($List.filter,
      function (event) {
         return A2($String.contains,$String.toLower(filterString$),$String.toLower(event.label));
      },
      events);
   });
   return _elm.EventList.Utils.values = {_op: _op,filterEventsByString: filterEventsByString};
};
Elm.Leaflet = Elm.Leaflet || {};
...
Elm.Leaflet.Update.make = function (_elm) {
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var eventToMarkers = function (events) {
      return A2($List.map,function (event) {    return A3($Leaflet$Model.Marker,event.id,event.marker.lat,event.marker.lng);},events);
   };
   var update = F2(function (action,model) {
      var _p0 = action;
      switch (_p0.ctor)
      {case "SelectMarker": return _U.update(model,{selectedMarker: _p0._0});
         case "SetMarkers": return _U.update(model,{markers: eventToMarkers(_p0._0)});
         case "ToggleMap": return _U.update(model,{showMap: $Basics.not(model.showMap)});
         default: return _U.update(model,{selectedMarker: $Maybe.Nothing});}
   });
   var UnselectMarker = {ctor: "UnselectMarker"};
   var ToggleMap = {ctor: "ToggleMap"};
   var SetMarkers = function (a) {    return {ctor: "SetMarkers",_0: a};};
   var SelectMarker = function (a) {    return {ctor: "SelectMarker",_0: a};};
   var init = $Leaflet$Model.initialModel;
   return _elm.Leaflet.Update.values = {_op: _op
                                       ,init: init
                                       ...
                                       ,update: update
                                       ,eventToMarkers: eventToMarkers};
};
Elm.Pages = Elm.Pages || {};
Elm.Pages.Event = Elm.Pages.Event || {};
Elm.Pages.Event.Utils = Elm.Pages.Event.Utils || {};
Elm.Pages.Event.Utils.make = function (_elm) {
   "use strict";
   _elm.Pages = _elm.Pages || {};
   _elm.Pages.Event = _elm.Pages.Event || {};
   _elm.Pages.Event.Utils = _elm.Pages.Event.Utils || {};
   if (_elm.Pages.Event.Utils.values) return _elm.Pages.Event.Utils.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Event$Model = Elm.Event.Model.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var filterEventsByAuthor = F2(function (events,authorFilter) {
      var _p0 = authorFilter;
      if (_p0.ctor === "Just") {
            return A2($List.filter,function (event) {    return _U.eq(event.author.id,_p0._0);},events);
         } else {
            return events;
         }
   });
   return _elm.Pages.Event.Utils.values = {_op: _op,filterEventsByAuthor: filterEventsByAuthor};
};
Elm.Pages = Elm.Pages || {};
Elm.Pages.Event = Elm.Pages.Event || {};
Elm.Pages.Event.Update = Elm.Pages.Event.Update || {};
Elm.Pages.Event.Update.make = function (_elm) {
   "use strict";
   _elm.Pages = _elm.Pages || {};
   _elm.Pages.Event = _elm.Pages.Event || {};
   _elm.Pages.Event.Update = _elm.Pages.Event.Update || {};
   if (_elm.Pages.Event.Update.values) return _elm.Pages.Event.Update.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Company$Model = Elm.Company.Model.make(_elm),
   $Config = Elm.Config.make(_elm),
   ...
   $Debug = Elm.Debug.make(_elm),
   $Effects = Elm.Effects.make(_elm),
   $Event$Decoder = Elm.Event.Decoder.make(_elm),
   $Event$Model = Elm.Event.Model.make(_elm),
   $EventAuthorFilter$Update = Elm.EventAuthorFilter.Update.make(_elm),
   $EventCompanyFilter$Update = Elm.EventCompanyFilter.Update.make(_elm),
   $EventList$Update = Elm.EventList.Update.make(_elm),
   $EventList$Utils = Elm.EventList.Utils.make(_elm),
   $Http = Elm.Http.make(_elm),
   $Leaflet$Update = Elm.Leaflet.Update.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Pages$Event$Model = Elm.Pages.Event.Model.make(_elm),
   $Pages$Event$Utils = Elm.Pages.Event.Utils.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $Task = Elm.Task.make(_elm),
   $TaskTutorial = Elm.TaskTutorial.make(_elm),
   $Time = Elm.Time.make(_elm);
   var _op = {};
   var Context = F3(function (a,b,c) {    return {accessToken: a,backendConfig: b,companies: c};});
   ...
   var ChildEventListAction = function (a) {    return {ctor: "ChildEventListAction",_0: a};};
   var ChildEventCompanyFilterAction = function (a) {    return {ctor: "ChildEventCompanyFilterAction",_0: a};};
   var ChildEventAuthorFilterAction = function (a) {    return {ctor: "ChildEventAuthorFilterAction",_0: a};};
   ...
   var getJson = F3(function (url,maybeCompanyId,accessToken) {
      var params = _U.list([{ctor: "_Tuple2",_0: "access_token",_1: accessToken}]);
      var params$ = function () {
         var _p0 = maybeCompanyId;
         if (_p0.ctor === "Just") {
               return A2($List._op["::"],{ctor: "_Tuple2",_0: "filter[company]",_1: $Basics.toString(_p0._0)},params);
            } else {
               return params;
            }
      }();
      var encodedUrl = A2($Http.url,url,params$);
      var httpTask = $Task.toResult(A2($Http.get,$Event$Decoder.decode,encodedUrl));
      var actionTask = A2($Task.andThen,
      httpTask,
      function (result) {
   ...
   var getDataFromCache = F2(function (status,maybeCompanyId) {
      ...
      var actionTask = function () {
         var _p1 = status;
         if (_p1.ctor === "Fetched") {
               return _U.eq(_p1._0,maybeCompanyId) ? A2($Task.map,
               function (currentTime) {
                  return _U.cmp(_p1._1 + $Config.cacheTtl,currentTime) > 0 ? NoOp : GetDataFromServer(maybeCompanyId);
               },
   ...
   var update = F3(function (context,action,model) {
      var _p2 = action;
      switch (_p2.ctor)
      {case "ChildEventAuthorFilterAction": var childModel = A2($EventAuthorFilter$Update.update,_p2._0,model.eventAuthorFilter);
           return {ctor: "_Tuple2"
                  ,_0: _U.update(model,{eventAuthorFilter: childModel})
                  ,_1: $Effects.task($Task.succeed(ChildLeafletAction($Leaflet$Update.SetMarkers(A2($Pages$Event$Utils.filterEventsByAuthor,
                  model.events,
                  childModel)))))};
         case "ChildEventCompanyFilterAction": var _p4 = _p2._0;
           var maybeCompanyId = function () {    var _p3 = _p4;return _p3._0;}();
           var childModel = A3($EventCompanyFilter$Update.update,context.companies,_p4,model.eventCompanyFilter);
           return {ctor: "_Tuple2",_0: _U.update(model,{eventCompanyFilter: childModel}),_1: $Effects.task($Task.succeed(GetData(maybeCompanyId)))};
         case "ChildEventListAction": var _p6 = _p2._0;
           var filteredEventsByAuthor = A2($Pages$Event$Utils.filterEventsByAuthor,model.events,model.eventAuthorFilter);
           var childModel = A3($EventList$Update.update,filteredEventsByAuthor,_p6,model.eventList);
           var childAction = function () {
              var _p5 = _p6;
              switch (_p5.ctor)
              {case "FilterEvents": return $Leaflet$Update.SetMarkers(A2($EventList$Utils.filterEventsByString,filteredEventsByAuthor,_p5._0));
                 case "SelectEvent": return $Leaflet$Update.SelectMarker(_p5._0);
                 default: return $Leaflet$Update.UnselectMarker;}
           }();
           return {ctor: "_Tuple2",_0: _U.update(model,{eventList: childModel}),_1: $Effects.task($Task.succeed(ChildLeafletAction(childAction)))};
         case "ChildLeafletAction": var childModel = A2($Leaflet$Update.update,_p2._0,model.leaflet);
           return {ctor: "_Tuple2",_0: _U.update(model,{leaflet: childModel}),_1: $Effects.none};
         case "GetData": var _p8 = _p2._0;
           var getFx = {ctor: "_Tuple2",_0: model,_1: A2(getDataFromCache,model.status,_p8)};
           var noFx = {ctor: "_Tuple2",_0: model,_1: $Effects.none};
           var _p7 = model.status;
           if (_p7.ctor === "Fetching") {
                 return _U.eq(_p7._0,_p8) ? noFx : getFx;
              } else {
                 return getFx;
              }
         case "GetDataFromServer": var _p10 = _p2._0;
           var backendUrl = function (_p9) {    return function (_) {    return _.backendUrl;}(function (_) {    return _.backendConfig;}(_p9));}(context);
           var url = A2($Basics._op["++"],backendUrl,"/api/v1.0/events");
           return {ctor: "_Tuple2",_0: _U.update(model,{status: $Pages$Event$Model.Fetching(_p10)}),_1: A3(getJson,url,_p10,context.accessToken)};
         case "NoOp": return {ctor: "_Tuple2",_0: model,_1: $Effects.none};
         case "UpdateDataFromServer": var _p11 = _p2._0;
           if (_p11.ctor === "Ok") {
                 var _p12 = _p11._0;
                 var filteredEventsByAuthor = A2($Pages$Event$Utils.filterEventsByAuthor,_p12,model.eventAuthorFilter);
                 var filteredEvents = A2($EventList$Utils.filterEventsByString,filteredEventsByAuthor,model.eventList.filterString);
                 return {ctor: "_Tuple2"
                        ,_0: _U.update(model,{events: _p12,status: A2($Pages$Event$Model.Fetched,_p2._1,_p2._2)})
                        ,_1: $Effects.batch(_U.list([$Effects.task($Task.succeed(ChildEventAuthorFilterAction($EventAuthorFilter$Update.UnSelectAuthor)))
                                                    ,$Effects.task($Task.succeed(ChildEventListAction($EventList$Update.UnSelectEvent)))
                                                    ,$Effects.task($Task.succeed(ChildEventListAction($EventList$Update.FilterEvents(""))))]))};
              } else {
                 return {ctor: "_Tuple2",_0: _U.update(model,{status: $Pages$Event$Model.HttpError(_p11._0)}),_1: $Effects.none};
              }
         case "Activate": var _p13 = _p2._0;
           var childModel = A2($Leaflet$Update.update,$Leaflet$Update.ToggleMap,model.leaflet);
           return {ctor: "_Tuple2"
                  ,_0: _U.update(model,{leaflet: childModel})
                  ,_1: $Effects.batch(_U.list([$Effects.task($Task.succeed(GetData(_p13)))
                                              ,$Effects.task($Task.succeed(ChildEventCompanyFilterAction($EventCompanyFilter$Update.SelectCompany(_p13))))]))};
         default: var childModel = A2($Leaflet$Update.update,$Leaflet$Update.ToggleMap,model.leaflet);
           return {ctor: "_Tuple2",_0: _U.update(model,{leaflet: childModel}),_1: $Effects.none};}
   });
   var init = {ctor: "_Tuple2",_0: $Pages$Event$Model.initialModel,_1: $Effects.none};
   return _elm.Pages.Event.Update.values = {_op: _op
                                           ,init: init
                                           ,NoOp: NoOp
                                           ,GetData: GetData
                                           ,GetDataFromServer: GetDataFromServer
                                           ,UpdateDataFromServer: UpdateDataFromServer
                                           ,ChildEventAuthorFilterAction: ChildEventAuthorFilterAction
                                           ,ChildEventCompanyFilterAction: ChildEventCompanyFilterAction
                                           ,ChildEventListAction: ChildEventListAction
...
Elm.App.Update.make = function (_elm) {
   ...
   $Pages$Event$Update = Elm.Pages.Event.Update.make(_elm),
   ...
   var update = F2(function (action,model) {
      ...
      {case "ChildArticleAction": var context = {accessToken: model.accessToken
         ...
         case "ChildEventAction": var context = {accessToken: model.accessToken
           ...
           var _p7 = A3($Pages$Event$Update.update,context,_p0._0,model.events);
         ...
         case "SetActivePage": var _p28 = _p0._0;
           var currentPageEffects = function () {
              ...
              if (_p24.ctor === "Event") {
                    return $Effects.task($Task.succeed(ChildEventAction($Pages$Event$Update.Deactivate)));
                 } else {
                    return $Effects.none;
                 }
           }();
           ...
           var newPageEffects = function () {
              ...
              {case "Article": return $Effects.task($Task.succeed(ChildArticleAction($Pages$Article$Update.Activate)));
                 case "Event": return $Effects.task($Task.succeed(ChildEventAction($Pages$Event$Update.Activate(_p27._0))));
...
Elm.Pages = Elm.Pages || {};
Elm.Pages.Event = Elm.Pages.Event || {};
Elm.Pages.Event.Router = Elm.Pages.Event.Router || {};
Elm.Pages.Event.Router.make = function (_elm) {
   "use strict";
   _elm.Pages = _elm.Pages || {};
   _elm.Pages.Event = _elm.Pages.Event || {};
   _elm.Pages.Event.Router = _elm.Pages.Event.Router || {};
   if (_elm.Pages.Event.Router.values) return _elm.Pages.Event.Router.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   var delta2update = F2(function (previous,current) {
      var url = function () {
         var _p2 = current.eventCompanyFilter;
         if (_p2.ctor === "Just") {
   ...
   return _elm.Pages.Event.Router.values = {_op: _op,delta2update: delta2update,location2company: location2company};
};
Elm.App = Elm.App || {};
...
Elm.App.Router.make = function (_elm) {
   ...
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Pages$Event$Router = Elm.Pages.Event.Router.make(_elm),
   $Result = Elm.Result.make(_elm),
   $RouteHash = Elm.RouteHash.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
      ...
      _v0_6: do {
         if (_p0.ctor === "::") {
               ...
               {case "auth": if (_p0._1.ctor === "::" && _p0._1._0 === "github" && _p0._1._1.ctor === "[]") {
                  ...
                  case "events": return A2($List._op["::"],
                    $App$Update.SetActivePage($App$Model.Event($Pages$Event$Router.location2company(_p0._1))),
                    _U.list([]));
   ...
   var delta2update = F2(function (previous,current) {
      ...
      {case "Article": return $Maybe.Just($RouteHash.set(_U.list(["articles"])));
         case "Event": return A2($RouteHash.map,
           ...
           A2($Pages$Event$Router.delta2update,previous.events,current.events));
...
Elm.EventAuthorFilter = Elm.EventAuthorFilter || {};
Elm.EventAuthorFilter.View = Elm.EventAuthorFilter.View || {};
Elm.EventAuthorFilter.View.make = function (_elm) {
   "use strict";
   _elm.EventAuthorFilter = _elm.EventAuthorFilter || {};
   _elm.EventAuthorFilter.View = _elm.EventAuthorFilter.View || {};
   if (_elm.EventAuthorFilter.View.values) return _elm.EventAuthorFilter.View.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Dict = Elm.Dict.make(_elm),
   ...
   var groupEventsByAuthors = function (events) {
      var handleEvent = F2(function (event,dict) {
         ...
         var newValue = function () {    var _p0 = currentValue;return {ctor: "_Tuple2",_0: _p0._0,_1: _p0._1 + 1};}();
         return A3($Dict.insert,event.author.id,newValue,dict);
      });
      return A3($List.foldl,handleEvent,$Dict.empty,events);
   };
   var viewEventsByAuthors = F3(function (events,address,eventAuthorFilter) {
      var getText = F2(function (author,count) {
         ...
         _U.list([$Html$Attributes.href("javascript:void(0);"),A2($Html$Events.onClick,address,$EventAuthorFilter$Update.SelectAuthor(author.id))]),
         _U.list([authorRaw]));
         var authorUnselect = A2($Html.span,
         _U.list([]),
         _U.list([A2($Html.a,
                 _U.list([$Html$Attributes.$class("unselect fa fa-times-circle")
                         ,$Html$Attributes.href("javascript:void(0);")
                         ,A2($Html$Events.onClick,address,$EventAuthorFilter$Update.UnSelectAuthor)]),
                 _U.list([]))
                 ,authorRaw]));
         var _p1 = eventAuthorFilter;
         if (_p1.ctor === "Just") {
               return _U.eq(author.id,_p1._0) ? authorUnselect : authorSelect;
            } else {
               return authorSelect;
            }
      });
      var viewAuthor = function (_p2) {    var _p3 = _p2;return A2($Html.li,_U.list([]),_U.list([A2(getText,_p3._0,_p3._1)]));};
      return A2($List.map,viewAuthor,$Dict.values(groupEventsByAuthors(events)));
   });
   var view = F3(function (events,address,eventAuthorFilter) {
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("wrapper -suffix")]),
      _U.list([A2($Html.h3,
              _U.list([$Html$Attributes.$class("title")]),
              _U.list([A2($Html.i,_U.list([$Html$Attributes.$class("glyphicon glyphicon-user")]),_U.list([]))
                      ,$Html.text(A2($Basics._op["++"]," ","Event Authors"))]))
              ,A2($Html.ul,_U.list([$Html$Attributes.$class("authors")]),A3(viewEventsByAuthors,events,address,eventAuthorFilter))]));
   });
   return _elm.EventAuthorFilter.View.values = {_op: _op,view: view,viewEventsByAuthors: viewEventsByAuthors,groupEventsByAuthors: groupEventsByAuthors};
};
Elm.EventCompanyFilter = Elm.EventCompanyFilter || {};
Elm.EventCompanyFilter.View = Elm.EventCompanyFilter.View || {};
Elm.EventCompanyFilter.View.make = function (_elm) {
   "use strict";
   _elm.EventCompanyFilter = _elm.EventCompanyFilter || {};
   _elm.EventCompanyFilter.View = _elm.EventCompanyFilter.View || {};
   if (_elm.EventCompanyFilter.View.values) return _elm.EventCompanyFilter.View.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Company$Model = Elm.Company.Model.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   ...
   $String = Elm.String.make(_elm);
   var _op = {};
   var companyListForSelect = F3(function (address,companies,eventCompanyFilter) {
      var selectedId = function () {    var _p0 = eventCompanyFilter;if (_p0.ctor === "Just") {    return _p0._0;} else {    return 0;}}();
      ...
      var selectedText = function () {    var _p2 = eventCompanyFilter;if (_p2.ctor === "Just") {    return $Basics.toString(_p2._0);} else {    return "";}}();
      return A2($Html.select,
      _U.list([$Html$Attributes.$class("companies")
              ,$Html$Attributes.value(selectedText)
              ,A3($Html$Events.on,
              "change",
              $Html$Events.targetValue,
              function (str) {
                 return A2($Signal.message,address,$EventCompanyFilter$Update.SelectCompany(textToMaybe(str)));
              })]),
      A2($List.map,getOption,companies$));
   });
   var view = F3(function (companies,address,model) {
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("wrapper -suffix")]),
      _U.list([A2($Html.h3,
              _U.list([$Html$Attributes.$class("title")]),
              _U.list([A2($Html.i,_U.list([$Html$Attributes.$class("fa fa-briefcase")]),_U.list([])),$Html.text(A2($Basics._op["++"]," ","Companies"))]))
              ,A3(companyListForSelect,address,companies,model)]));
   });
   return _elm.EventCompanyFilter.View.values = {_op: _op,view: view,companyListForSelect: companyListForSelect};
};
Elm.EventList = Elm.EventList || {};
Elm.EventList.View = Elm.EventList.View || {};
Elm.EventList.View.make = function (_elm) {
   "use strict";
   _elm.EventList = _elm.EventList || {};
   _elm.EventList.View = _elm.EventList.View || {};
   if (_elm.EventList.View.values) return _elm.EventList.View.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Event$Model = Elm.Event.Model.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var viewListEvents = F3(function (events,address,model) {
      var eventUnselect = function (event) {
         ...
         _U.list([A2($Html.a,
                 _U.list([$Html$Attributes.$class("unselect fa fa-times-circle")
                         ,$Html$Attributes.href("javascript:void(0);")
                         ,A2($Html$Events.onClick,address,$EventList$Update.UnSelectEvent)]),
                 _U.list([]))
      ...
      var eventSelect = function (event) {
         ...
         _U.list([]),
         _U.list([A2($Html.a,
         _U.list([hrefVoid,A2($Html$Events.onClick,address,$EventList$Update.SelectEvent($Maybe.Just(event.id)))]),
         _U.list([$Html.text(event.label)]))]));
      };
      var getListItem = function (event) {
         var _p0 = model.selectedEvent;
         if (_p0.ctor === "Just") {
               return _U.eq(event.id,_p0._0) ? eventUnselect(event) : eventSelect(event);
            } else {
               return eventSelect(event);
            }
      };
      var filteredEvents = A2($EventList$Utils.filterEventsByString,events,model.filterString);
      return $List.isEmpty(filteredEvents) ? A2($Html.div,_U.list([]),_U.list([$Html.text("No results found")])) : A2($Html.ul,
      _U.list([$Html$Attributes.$class("authors")]),
      A2($List.map,getListItem,filteredEvents));
   });
   var viewFilterString = F2(function (address,model) {
      return A2($Html.div,
      _U.list([]),
      _U.list([A2($Html.input,
      _U.list([$Html$Attributes.$class("search form-control")
              ,$Html$Attributes.placeholder("Filter events")
              ,$Html$Attributes.value(model.filterString)
              ,A3($Html$Events.on,
              "input",
              $Html$Events.targetValue,
              function (_p1) {
                 return A2($Signal.message,address,$EventList$Update.FilterEvents(_p1));
              })]),
      _U.list([]))]));
   });
   var view = F3(function (events,address,model) {
      return A2($Html.div,
      _U.list([$Html$Attributes.id("events"),$Html$Attributes.$class("wrapper -suffix")]),
      _U.list([A2($Html.h3,
              _U.list([$Html$Attributes.$class("title")]),
              _U.list([A2($Html.i,_U.list([$Html$Attributes.$class("fa fa-map-marker")]),_U.list([])),$Html.text(A2($Basics._op["++"]," ","Event List"))]))
              ,A2(viewFilterString,address,model)
              ,A3(viewListEvents,events,address,model)]));
   });
   return _elm.EventList.View.values = {_op: _op,view: view};
};
Elm.Pages = Elm.Pages || {};
Elm.Pages.Event = Elm.Pages.Event || {};
Elm.Pages.Event.View = Elm.Pages.Event.View || {};
Elm.Pages.Event.View.make = function (_elm) {
   "use strict";
   _elm.Pages = _elm.Pages || {};
   _elm.Pages.Event = _elm.Pages.Event || {};
   _elm.Pages.Event.View = _elm.Pages.Event.View || {};
   if (_elm.Pages.Event.View.values) return _elm.Pages.Event.View.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Company$Model = Elm.Company.Model.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $EventAuthorFilter$View = Elm.EventAuthorFilter.View.make(_elm),
   $EventCompanyFilter$View = Elm.EventCompanyFilter.View.make(_elm),
   $EventList$View = Elm.EventList.View.make(_elm),
   $Html = Elm.Html.make(_elm),
   $Html$Attributes = Elm.Html.Attributes.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   ...
   var view = F3(function (context,address,model) {
      var filteredEvents = A2($Pages$Event$Utils.filterEventsByAuthor,model.events,model.eventAuthorFilter);
      var childEventListAddress = A2($Signal.forwardTo,address,$Pages$Event$Update.ChildEventListAction);
      var childEventCompanyFilterAddress = A2($Signal.forwardTo,address,$Pages$Event$Update.ChildEventCompanyFilterAction);
      var childEventAuthorFilterAddress = A2($Signal.forwardTo,address,$Pages$Event$Update.ChildEventAuthorFilterAction);
      return A2($Html.div,
      _U.list([$Html$Attributes.id("events-page"),$Html$Attributes.$class("container")]),
      _U.list([A2($Html.div,
      _U.list([$Html$Attributes.$class("row")]),
      _U.list([A2($Html.div,
              _U.list([$Html$Attributes.$class("col-md-3 first")]),
              _U.list([A3($EventCompanyFilter$View.view,context.companies,childEventCompanyFilterAddress,model.eventCompanyFilter)
                      ,A3($EventAuthorFilter$View.view,model.events,childEventAuthorFilterAddress,model.eventAuthorFilter)
                      ,A3($EventList$View.view,filteredEvents,childEventListAddress,model.eventList)]))
              ,A2($Html.div,
              _U.list([$Html$Attributes.$class("col-md-9 last")]),
              _U.list([A2($Html.div,
              _U.list([$Html$Attributes.$class("map-container wrapper -suffix")]),
              _U.list([A2($Html.h3,
                      _U.list([$Html$Attributes.$class("title")]),
                      _U.list([A2($Html.i,_U.list([$Html$Attributes.$class("fa fa-globe")]),_U.list([])),$Html.text(A2($Basics._op["++"]," ","Map"))]))
                      ,A2($Html.div,
                      _U.list([$Html$Attributes.$class("map-wrapper")]),
                      _U.list([A2($Html.div,_U.list([$Html$Attributes.id("map")]),_U.list([]))]))]))]))]))]));
   });
   var Context = function (a) {    return {companies: a};};
   return _elm.Pages.Event.View.values = {_op: _op,Context: Context,view: view};
};
Elm.Pages = Elm.Pages || {};
Elm.Pages.GithubAuth = Elm.Pages.GithubAuth || {};
   ...
   var view = F2(function (address,model) {
      ...
      if (_p0.ctor === "Anonymous") {
            ...
            _U.list([mainTitle
                    ...
                    ,A2($Html.ol,_U.list([$Html$Attributes.$class("companies")]),A2($List.map,viewCompanies,model.companies))]))]));
         }
   });
...
Elm.App.View.make = function (_elm) {
   ...
   $Pages$Event$View = Elm.Pages.Event.View.make(_elm),
   ...
   var mainContent = F2(function (address,model) {
      ...
      {case "Article": var childAddress = A2($Signal.forwardTo,address,$App$Update.ChildArticleAction);
         ...
         case "Event": var context = {companies: model.companies};
           ...
           return A2($Html.div,_U.list([$Html$Attributes.style(myStyle)]),_U.list([A3($Pages$Event$View.view,context,childAddress,model.events)]));
...
Elm.Main.make = function (_elm) {
   ...
   var app = $StartApp.start({init: $App$Update.init
                             ...
                             ,inputs: _U.list([messages.signal
                                              ...
                                              ,A2($Signal.map,
                                              function (_p2) {
                                                 return $App$Update.ChildEventAction($Pages$Event$Update.ChildEventListAction($EventList$Update.SelectEvent(_p2)));
                                              },
                                              selectEvent)])});
   var main = app.html;
